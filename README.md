...
This branch currently pings an Eth GAS API once a minute (https://ethgasstation.info/api/ethgasAPI.json?) and it will send you a mac browser alert if the eth gas price falls below a threshold of some amount of gwei as set in config.json.
